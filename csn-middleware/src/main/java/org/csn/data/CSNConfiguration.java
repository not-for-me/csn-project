...
public class CSNConfiguration {
	...
	public String toString() {
		return MoreObjects.toStringHelper(getClass()).add("csnName", csnName)
				.add("creationTime", creationTime).add("adminName", adminName)
				.add("adminEmail", adminEmail)
				.add("persistOption", persistOption).toString();
	}
}
