...
public class SensorNetworkDAO {
    ...
    public boolean isNetworkID(String id) {
        ...
        try {
            ...
            PreparedStatement ps = c.prepareStatement(
                    "SELECT EXISTS(SELECT id  FROM csn_sn WHERE id = ?)");
            ps.setString(1, id);
    ...
    public String registerNetwork(String name, int cnt) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "INSERT INTO csn_sn (id, name, child_net_cnt, reg_time, status) VALUES(?, ?, ?, NOW(), 'Operating')");
            ps.setString(1,id);
            ps.setString(2, name);
            ps.setInt(3, cnt);
            ps.executeUpdate();
            ...
            if(members != null) {
                for(String member : members) {
                    ...
                    if(ret == ReturnType.Error)
                        throw new Exception("Can't set a Network Members to the Sensor Network");
                }
            } else {
    ...
    private ReturnType _addMember(String id, String member) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "INSERT INTO csn_sn_member (parent_id, member_id) VALUES(?, ?)");
            ps.setString(1, id);
    ...
    public ReturnType updateTopicPath(String id, String topicPath) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "UPDATE csn_sn SET topic_path = ? WHERE id = ?");
    ...
    public Set<SensorNetwork> getAllNetworks() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT * FROM csn_sn WHERE status = 'Operating'");
            ResultSet rs = ps.executeQuery();
            while(rs.next()) {
                String id = rs.getString("id");
                Set<String> memberList = this.getMemberIDs(id);
                SensorNetwork network = new SensorNetwork(
                        id, rs.getString("name"), rs.getString("reg_time"),
                        rs.getString("dereg_time"), rs.getString("status"), rs.getInt("topic_id"),
                        rs.getString("topic_path"), rs.getInt("child_net_cnt"), memberList
                );
                set.add(network);
            }
    ...
    public ReturnType deactivateAllNetworks() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "UPDATE csn_sn SET status = 'Stopped', dereg_time = now()" );
    ...
    public Set<String> getAllNetworkNames() {
        ...
        try {
            ...
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT name FROM csn_sn WHERE status = 'Operating'");
            ResultSet rs = ps.executeQuery();
            while(rs.next())
    ...
    public Set<String> getNetworkNames(int index, int num) {
        ...
        try {
            ...
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT name FROM csn_sn WHERE status='Operating' ORDER BY id ASC LIMIT ?, ?");
            ps.setInt(1, index);
            ps.setInt(2, num);
            ResultSet rs = ps.executeQuery();
            while(rs.next())
    ...
    public Set<String> getAllMemberNetworkIDs() {
        ...
        try {
            idSet = new HashSet<String>();
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT DISTINCT member_id FROM csn_sn_member");
            ResultSet rs = ps.executeQuery();
            while(rs.next())
    ...
    public Set<String> getAllNetworkTopicPaths() {
        ...
        try {
            ...
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT topic_path FROM csn_sn WHERE status='Operating'");
            ResultSet rs = ps.executeQuery();
            while(rs.next()) {
    ...
    public int getOperatingNetworkCount() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT COUNT(id) FROM csn_sn WHERE status='Operating'");
            ResultSet rs = ps.executeQuery();
            if(rs.next())
                count = rs.getInt(1);
    ...
    public int getStoppedNetworkCount() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT COUNT(id) FROM csn_sn WHERE status='Stopped'");
            ResultSet rs = ps.executeQuery();
            if(rs.next())
                count = rs.getInt(1);
    ...
    public int getFaultedNetworkCount() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT COUNT(id) FROM csn_sn WHERE status='Faulted'");
            ResultSet rs = ps.executeQuery();
            if(rs.next())
                count = rs.getInt(1);
    ...
    public int getAllNetworkCount() {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement("SELECT COUNT(id) FROM csn_sn");
            ResultSet rs = ps.executeQuery();
            if(rs.next())
                count = rs.getInt(1);
    ...
    public SensorNetwork getNetwork(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT * FROM csn_sn WHERE status = 'Operating' AND id = ?");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            if(rs.next()) {
                Set<String> memberList = this.getMemberIDs(id);
    ...
    public String getNetworkName(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT name FROM csn_sn WHERE status = 'Operating' AND id = ?");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            if(rs.next())
    ...
    public ReturnType removeNetwork(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "UPDATE csn_sn SET status = 'Stopped' WHERE id = ?");
            ps.setString(1, id);
            ps.executeUpdate();
    ...
    public boolean isItNetwork(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT EXISTS(SELECT *  FROM csn_sn WHERE status = 'Operating' AND id = ?)");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            rs.next();
            ret = rs.getBoolean(1);
    ...
    public Set<SensorNetwork> getParentNetworks(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT parent_id FROM csn_sn_member WHERE member_id = ?");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            while(rs.next())
    ...
    public boolean hasMembers(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT EXISTS(SELECT member_id FROM csn_sn_member WHERE parent_id = ?)");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            rs.next();
            ret = rs.getBoolean(1);
    ...
    public String getTopicPath(String id) {
        ...
        try {
            Connection c = connectionMaker.makeConnection();
            PreparedStatement ps = c.prepareStatement(
                    "SELECT topic_path FROM csn_sn WHERE status = 'Operating' AND id = ?");
            ps.setString(1, id);
            ResultSet rs = ps.executeQuery();
            rs.next();
